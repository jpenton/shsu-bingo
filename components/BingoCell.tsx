  ...
  return (
    <div
      className={classnames(
        'relative bingo-cell flex flex-1 justify-center items-center select-none cursor-pointer p-2 text-center text-xs md:text-base',
        roundCorner &&
        ...
        win
          ...
          : [
              ...
              !locked && 'active:bg-cool-grey-100 active:border-cool-grey-200',
            ],
          ...
          {Array(countMax)
            ...
            .map((_, index) => (
              <svg
                ...
                viewBox="0 0 24 24"
                className={classnames(
                  'w-8 icon-check fill-current',
                  index <= count - 1 ? 'text-teal-500' : 'text-teal-200',
                )}
              >
